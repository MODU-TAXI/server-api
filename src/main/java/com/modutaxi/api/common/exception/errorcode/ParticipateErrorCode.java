...
public enum ParticipateErrorCode implements ErrorCode {
    ...
    USER_ALREADY_IN_WAITING_LIST("PRT_003", "해당 사용자가 대기열에 없습니다.", HttpStatus.BAD_REQUEST),
    USER_ALREADY_IN_ROOM("PRT_004", "해당 사용자가 이미 해당 채팅방에 존재합니다.", HttpStatus.BAD_REQUEST),
    ;
