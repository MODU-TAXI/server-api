...
@Aspect
@Component
public class IODebugLogAnnotationAop {
    @AfterThrowing(pointcut = "@annotation(com.modutaxi.api.common.log.IODebugLog)", throwing = "exception")
    ...
    @Around("@annotation(com.modutaxi.api.common.log.IODebugLog)")
