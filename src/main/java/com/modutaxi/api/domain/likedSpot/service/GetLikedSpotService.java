...
public class GetLikedSpotService {
    ...
    public PageResponseDto<List<LikedSpotListResponse>> getLikedSpotList(int page, int size) {
        Pageable pageable = PageRequest.of(page, size);
        Slice<LikedSpotResponseInterface> likedSpotSlice = likedSpotRepository.findAllByOrderByCreatedAtDesc(pageable);
