...
public class ParticipantController {
    ...
    public ResponseEntity<RoomWaitingMapper.MemberRoomInResponseList> getParticipateInRoom(@CurrentMember Member member,
                                                                                           @PathVariable String roomId) {
        return ResponseEntity.ok(getParticipantService.getParticipateInRoom(member, Long.valueOf(roomId)));
    }
    ...
    public ResponseEntity<RoomWaitingMapper.ApplyResponse> acceptForParticipate(
        ...
        return ResponseEntity.ok(registerParticipantService.acceptForParticipate(member, roomId, memberId));
    }
    ...
    public ResponseEntity<ChatResponseDto.DeleteResponse> deleteChatRoomInfo(@CurrentMember Member member) {
        return ResponseEntity.ok(updateParticipantService.leaveRoomAndDeleteChatRoomInfo(member.getId()));
    }
}
